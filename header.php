...
<body <?php body_class(); ?>>
<?php global $colornews_duplicate_posts; $colornews_duplicate_posts = array(); ?>
   ...
   <?php do_action( 'colornews_before_header' ); ?>
	...
	<header id="masthead" class="site-header" role="banner">
      ...
      <div class="middle-header-wrapper <?php echo $show_both_class; ?> clearfix">
         <div class="tg-container">
            <div class="tg-inner-wrap home__logo">
            <?php
               ...
               <div id="header-text" class="<?php echo $screen_reader; ?>">
                  <?php if ( is_front_page() || is_home() ) : ?>
                     <h1 id="site-title" class="home__title text__upper">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
                     </h1><!-- #site-title -->
                  <?php else : ?>
                     <h3 id="site-title" class="home__title text__upper">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
                     </h3>
                  <?php endif; ?>
                  <?php
                  ...
                  if ( $description || is_customize_preview() ) : ?>
                     <p id="site-description" class="hidden__xs"><?php echo $description; ?></p>
                  <?php endif;?>
                  <!-- #site-description -->
               </div><!-- #header-text -->
